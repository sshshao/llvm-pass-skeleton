...
@.str = private unnamed_addr constant [19 x i8] c"Return value is %d\00", align 1
...
define i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i32 %5)
  ret i32 0
}
